...
val DarkOledSurface = Color(0xFF13131A)          // Superficie principal de tarjetas y barras
val DarkOledSurfaceVariant = Color(0xFF1A1A24)   // Superficie nivel 2 / Elevada
val DarkOledBorder = Color(0xFF262636)           // Borde sutil fino
val DarkOledBorderFocused = Color(0xFF3B3B52)    // Borde con foco / selección

// Enterprise Slate & Cobalt Palette (Compatibilidad)
val Slate950 = Color(0xFF020617)
val Slate900 = Color(0xFF09090D)
val Slate800 = Color(0xFF13131A)
val Slate700 = Color(0xFF262636)
val Slate600 = Color(0xFF475569)
val Slate500 = Color(0xFF64748B)
val Slate400 = Color(0xFF9090A6)
...
val DarkSurface = DarkOledSurface
val DarkSurfaceVariant = DarkOledSurfaceVariant
val DarkContainer = ElectricIndigoContainer

// Light Theme Surfaces
val LightBackground = Color(0xFFF8FAFC)
val LightSurface = Color(0xFFFFFFFF)
val LightSurfaceVariant = Color(0xFFF1F5F9)
val LightContainer = Color(0xFFEEF2FF)

// Functional & Integration Colors
...
val PropiaGreenFgLight = Color(0xFF15803D)
val PropiaGreenBgDark = Color(0xFF064E3B)
val PropiaGreenFgDark = Color(0xFF6EE7B7)

val ProveedorPurpleBgLight = Color(0xFFF3E8FF)
val ProveedorPurpleFgLight = Color(0xFF7E22CE)
val ProveedorPurpleBgDark = Color(0xFF2E1065)
val ProveedorPurpleFgDark = Color(0xFFC084FC)

// Text Colors (Alto Contraste y Legibilidad)
val TextPrimaryDark = Color(0xFFFFFFFF)
val TextSecondaryDark = Color(0xFF9090A6)
